				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-10">
						<div class="box-control">
							...
							<div class="mini-cart">
								<a class="cart-link" href="#"><span class="pe-7s-cart"></span> <span class="count">2</span></a>
								<div class="show-shopping-cart">
	                                <h3 class="title">Bạn có <span class="text-primary">(2 mặt hàng)</span> trong giỏ hàng</h3>
